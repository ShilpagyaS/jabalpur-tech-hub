        ...
        <div className="border-t border-white/5 pt-6 text-center">
          <div className="flex justify-center gap-5 mb-4">
            {[
              ...
              {
                label: "YouTube",
                href: "https://www.youtube.com/@microlandcomputer",
              ...
              <a
                ...
                aria-label={label}
                className={`w-11 h-11 flex items-center justify-center rounded-full bg-gradient-to-br ${gradient} shadow-lg transition-all duration-300 hover:scale-110`}
              >
                {icon}
              </a>
            ))}
